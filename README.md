...
MY IMPLEMENTATION TO SEARX
PROOF THAT SEARX WORKS AND PROTECTS YOUR INFORMATION
...
Challenges:
* Configuration and building Searx can be tricky
* Finding and understanding the communication or how the user knows if Searx is communicating with e.g. Google.
